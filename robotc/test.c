...
#pragma config(Motor,  port2,           lGoal,         tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port7,           vertibar,      tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
	...
	while(true) {
		...
		//mobile goal
		motor[port2] = 100 * vexRT[Btn7U] + -100 * vexRT[Btn7L];
		motor[port3] = -(100 * vexRT[Btn7U] + -100 * vexRT[Btn7L]);
